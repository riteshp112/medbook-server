...
def invoke():
  ...
  if invokeType=="insert":
    ...
    return Response(headers={"output":data,"Access-Control-Allow-Origin": "*","Access-Control-Allow-Headers":"*","Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,OPTIONS","Access-Control-Allow-Credentials" : True ,"Content-Type" :"application/json","Cache-Control": "no-cache"})
